...
Mavaddat Javid, Grigoriy Mikhalkin, Donald Eugene Parker, Eduard Pascual Saez, mrBB, Hanna
...
%% Give examples of power series.
%% Find the radius of convergence of a power series.
%% Determine the interval on which a power series converges.
%% Find a power series for a function by transforming $1/(1-x)$.

%% Differentiate a power series term-by-term.
%% Integrate a power series term-by-term.
%% Describe what happens to the radius of convergence when you differentiate or integrate a power series term-by-term.
%% Multiply and divide power series.
%% Use a power series to approximate a definite integral.
