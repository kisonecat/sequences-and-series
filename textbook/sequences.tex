...
Introduction to this textbook, we saw the sequence $\ds
a_i=f(i)=1-1/2^i$, and other examples are easy to cook up, like
\begin{align*}
  a_i &={i\over i+1}, \\
  b_n &={1\over2^n}, \\
...
The \defnword{triangular numbers} are a sequence of whole numbers
counting the number of dots in increasingly large ``equilateral
triangles'' built from dots.  The term $T_n$ is the number of dots in
a triangle with $n$ dots to a side.
